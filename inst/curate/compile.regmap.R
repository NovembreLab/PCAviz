# Procure the RegMap data, and compute principal components (PCs) from
# the genotype data. This script was tested in R 3.3.2 using
# data.table 1.9.6 and rsvd 0.6.
#
# Follow these steps to retrieve the RegMap data:
#
#   1. wget http://bergelson.uchicago.edu/wp-content/uploads/2015/04/call_method_75.tar.gz
#
